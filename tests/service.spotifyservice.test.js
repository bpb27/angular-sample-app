describe('spotify service', function () {
    ...
    describe('creating embeddable iframe', function () {
        ...
        it('takes an optional height parameter', function () {

            var html = SpotifyService.getEmbedFrame('track', trackId, 300, 400).$$unwrapTrustedValue();
            var expectation = '<iframe src="https://embed.spotify.com/?uri=spotify:track:' + trackId + '" width="300" height="400" frameborder="0" allowtransparency="true"></iframe>';
